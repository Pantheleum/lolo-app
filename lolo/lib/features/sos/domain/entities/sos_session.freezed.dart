...
class _$SosSessionImpl implements _SosSession {
  ...
  @override
  String toString() {
    return 'SosSession(sessionId: $sessionId, scenario: $scenario, urgency: $urgency, immediateAdvice: $immediateAdvice, severityAssessmentRequired: $severityAssessmentRequired, estimatedResolutionSteps: $estimatedResolutionSteps, createdAt: $createdAt)';
  }
...
abstract class _SosSession implements SosSession {
  const factory _SosSession(
      ...
      required final DateTime createdAt}) = _$SosSessionImpl;
